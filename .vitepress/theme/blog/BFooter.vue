...
.footer {
    --at-apply: m-0 mx-auto my-4 text-center text-sm font-medium;
    white-space: nowrap;

    .copyright,
    .message {
        --at-apply: text-sm leading-5;
